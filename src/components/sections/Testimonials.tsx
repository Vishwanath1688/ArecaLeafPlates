          ...
          <AnimatePresence mode="popLayout">
            {visible.map((idx) => {
              ...
              return (
                ...
                >
                  <Quote size={28} className="text-[#2D6A2D]/20 mb-4" />
                  <p className="text-charcoal text-sm sm:text-base leading-relaxed mb-5 font-sans">
                    "{t.quote}"
                  </p>
                  <div className="border-t border-[#2D6A2D]/10 pt-4">
                    <p className="font-sans font-semibold text-charcoal text-sm sm:text-base">{t.name}</p>
          ...
          {TESTIMONIALS.map((_, i) => (
            <button
              ...
              style={{
                ...
                height: 8,
                backgroundColor: i === current ? '#1A3D2B' : '#1A3D2B33',
              }}
