        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <ScrollReveal direction="left">
            <div className="bg-[#1A3D2B] rounded-2xl p-8">
              <h3 className="font-sans text-xs font-bold tracking-widest uppercase text-[#7FB069] mb-6">
                ✓ Confirmed
              </h3>
              <div className="space-y-5">
                {CONFIRMED.map((c, i) => (
                  ...
                  >
                    ...
                    >
                      <CheckCircle size={22} className="text-[#7FB069] shrink-0 mt-0.5" />
                    </motion.div>
                    <div>
                      <p className="font-sans font-semibold text-white">{c.label}</p>
          ...
          <ScrollReveal direction="right">
            <div className="bg-purewhite border border-[#2D6A2D]/15 rounded-2xl p-8">
              <h3 className="font-sans text-xs font-bold tracking-widest uppercase text-[#2D6A2D] mb-6">
                ◯ In Progress
              </h3>
              <div className="space-y-5">
                {IN_PROGRESS.map((c, i) => (
                  ...
                  >
                    <Circle size={20} className="text-[#2D6A2D]/40 shrink-0 mt-0.5" />
                    <div>
                      <p className="font-sans font-semibold text-charcoal">{c.label}</p>
